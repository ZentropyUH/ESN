...
@app.command(
    name="forecast-folder",
    no_args_is_help=True,
)
def forecast_ESN_folder(
    trained_model_path: str = Option(
        ...,
        "--trained-model-path",
        "-tm",
    ...
    data_folder: str = Option(
        ...,
        "--data-folder",
        "-df",
        help="The data folder to be used for training the model",
    ),
    output_dir: str = Option(
        ...,
        "--output-dir",
    ...
    """Make predictions with a given model on a data folder."""
    from functions import forecast_folder_from_saved_model
    forecast_folder_from_saved_model(
        trained_model_path=trained_model_path,
