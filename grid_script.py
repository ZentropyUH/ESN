...
Value -> Tuple( initial_value, count_to_generate , increment_count, increment_function)
Increment_function describes how to encrease tha value -> x: initialv_value, y: increment, i: iteration_number
"""
