...
# save path
save="/data/tsa/destevez/MG/16.8/run_0/data"
mkdir -p $save
...
cp -r "/data/tsa/destevez/MG/16.8/info/0/combinations.json" $ESN

echo "copying data............"
cp -r /data/tsa/destevez/data/MG/16.8/* $data
echo "end of copy"
