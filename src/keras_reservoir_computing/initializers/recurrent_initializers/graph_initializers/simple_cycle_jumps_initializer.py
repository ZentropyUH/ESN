...
@tf.keras.utils.register_keras_serializable(package="krc", name="SimpleCycleJumpsGraphInitializer")
class SimpleCycleJumpsGraphInitializer(GraphInitializerBase):
    ...
    def _generate_adjacency_matrix(self, n: int) -> tf.Tensor:
        ...
        """
        adj = simple_cycle_jumps(n=n, jump_length=self.jump_length, r_c=self.r_c, r_l=self.r_l)
        return adj
